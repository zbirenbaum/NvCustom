local cmd = vim.cmd
local colors = require('nightfox.colors').init("duskfox")
...
local darker_black = colors.black_dm
local folder_bg = colors.cyan_br
local green = colors.green
local grey = colors.black_br
local grey_fg = colors.black_br
local line = colors.magenta
local nord_blue = colors.blue_dm
local one_bg = colors.black_dm
local one_bg2 = colors.black_dm
local pmenu_bg = colors.black
local purple = colors.pink
local red = colors.red
local white = colors.white
local yellow = colors.yellow
local orange = colors.orange
local one_bg3 = colors.black_dm
